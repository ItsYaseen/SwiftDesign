    ...
    var b = function() {
        ...
        b.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function(a, b, c) {
            ...
            d.prototype.selectionContainer = function() {
                return a('<li class="select2-selection__choice drop-down-texts"><span class="select2-selection__choice__remove" role="presentation"><i class="bi bi-x text-light"></i></span></li>')
            }
            ,
                ...
                0 !== a.length) {
                    for (var b = [], d = 0; d < a.length; d++) {
                        var e = a[d]
                          ...
                          , g = this.display(e, f);
                        f.find('span').before('<span>' + (e.title || e.text) + '</span>'); // Append text before <i> tag
                        //f.append(g),
